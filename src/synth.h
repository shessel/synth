...
void synth_update_generated_sound(int16_t* const buffer, const sound_desc* const sound_desc, const uint8_t num_sound_descs);
void synth_queue_track(int16_t* track_buffer, const uint32_t loop_count = 1);
void synth_queue_sound(int16_t* sound_buffer, const uint32_t loop_count = 1);
void synth_play(int16_t* buffer = nullptr, const uint32_t buffer_sizeu = 0, const uint32_t loop_count = 1);
